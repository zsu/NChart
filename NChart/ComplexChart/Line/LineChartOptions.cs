namespace NChart.ComplexChart.Line
{
    ...
    public class LineChartOptions : ComplexChartOptions
    {
        ...
        /// </summary>
        public double? ScaleGridLineWidth { get; set; }
        ...
        /// </summary>
        public double? BezierCurveTension { get; set; }
        ...
        /// </summary>
        public double? PointDotRadius { get; set; }

        /// <summary>
        /// Gets or sets the point dot stroke width.
        /// </summary>
        public double? PointDotStrokeWidth { get; set; }

        /// <summary>
        /// Gets or sets the point hit detection radius.
        /// </summary>
        public double? PointHitDetectionRadius { get; set; }
        ...
        /// </summary>
        public double? DatasetStrokeWidth { get; set; }
