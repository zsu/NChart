namespace NChart
{
    ...
    public abstract class GlobalChartOptions
    {
        ...
        /// </summary>
        public double? AnimationSteps { get; set; }
        ...
        /// </summary>
        public double? ScaleLineWidth { get; set; }
        ...
        /// </summary>
        public bool? ScaleIntegersOnly { get; set; }
        ...
        /// </summary>
        public string ScaleFontFamily { get; set; }
        ...
        /// </summary>
        public string ScaleFontStyle { get; set; }
        ...
        /// </summary>
        public bool? CustomTooltips { get; set; }

        /// <summary>
        /// Gets or sets array of string names to attach tooltip events.
        /// </summary>
        public string TooltipEvents { get; set; }
        ...
        /// </summary>
        public string TooltipTitleFontFamily { get; set; }

        /// <summary>
        /// Gets or sets the tooltip title font size in pixels.
        /// </summary>
        public double? TooltipTitleFontSize { get; set; }

        /// <summary>
        /// Gets or sets the tooltip title font weight style.
        /// </summary>
        public string TooltipTitleFontStyle { get; set; }

        /// <summary>
        /// Gets or sets the tooltip title font colour.
        /// </summary>
        public string TooltipTitleFontColor { get; set; }

        /// <summary>
        /// Gets or sets the pixel width of padding around tooltip text.
        /// </summary>
        public double? TooltipYPadding { get; set; }

        /// <summary>
        /// Gets or sets the pixel width of padding around tooltip text.
        /// </summary>
        public double? TooltipXPadding { get; set; }

        /// <summary>
        /// Gets or sets the size of the caret on the tooltip.
        /// </summary>
        public double? TooltipCaretSize { get; set; }
        ...
        /// </summary>
        public double? TooltipXOffset { get; set; }
